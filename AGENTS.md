...
This file provides guidance to Codex and other coding agents when working with code in this repository. It is generated from CLAUDE.md and differs only in this header — edit CLAUDE.md and regenerate rather than editing this file directly.
